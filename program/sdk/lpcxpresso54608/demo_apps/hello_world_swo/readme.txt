...
4.	Open JlinkerSWOView(C:\Program Files (x86)\SEGGER\JLink_xxx), select the target device, such as LPC54608J512 and make sure the core clock and swo clock frequency is equal to the demo setting, the demo use 4MHZ as SWO clock frequency and 12MHZ as core clock frequency.
...
Running the demo
================
The log below shows the output of the hello world swo demo in the JlinkerSWOView window and the demo will continuous print it with SW2 pressed:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SWO: hello_world
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
