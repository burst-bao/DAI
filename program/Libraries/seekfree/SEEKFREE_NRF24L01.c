...
void nrf_init(void)
{
    gpio_init(NRF_CE_PIN  ,GPO,0,NOPULL);
    gpio_init(NRF_CSN_PIN ,GPO,0,NOPULL);
    gpio_init(NRF_MOSI_PIN,GPO,0,NOPULL);
    gpio_init(NRF_SCK_PIN ,GPO,0,NOPULL);
              
    gpio_init(NRF_MISO_PIN,GPI,0,PULLUP);
    gpio_init(NRF_IRQ_PIN ,GPI,0,PULLUP);
