...
void SystemInit (void) 
{
    ...
    SYSCON->FLASHCFG = SYSCON_FLASHCFG_FETCHCFG(2)|SYSCON_FLASHCFG_DATACFG(2)|SYSCON_FLASHCFG_ACCEL_MASK|SYSCON_FLASHCFG_FLASHTIM(7);
